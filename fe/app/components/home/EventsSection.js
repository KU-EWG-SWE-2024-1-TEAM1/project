...
const EventsSection = () => {
    ...
    const renderEventInfo = (event) => {
        if (sortOption === 'views') {
            return <span className="z-50 text-2xl Do-Hyeon absolute top-64 left-12  bg-opacity-75 text-white p-2 gradient-text">{event.views} views</span>;
        } else if(sortOption === 'score')
        return (
            <div className="z-50 Do-Hyeon text-2xl  absolute top-64 left-12 bg-opacity-75 p-2 ">
